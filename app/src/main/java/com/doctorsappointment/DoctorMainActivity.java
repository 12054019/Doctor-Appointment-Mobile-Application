...
import com.doctorsappointment.DoctorFragments.AppointmentFragment;
import com.doctorsappointment.DoctorFragments.AppointmentRequestFragment;
...
public class DoctorMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        FirebaseDatabase.getInstance().getReference().child("DoctorDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
