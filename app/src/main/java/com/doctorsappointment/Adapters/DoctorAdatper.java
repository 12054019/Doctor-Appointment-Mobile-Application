...
import com.doctorsappointment.DataRetrievalClass.Doctor;
import com.doctorsappointment.PatientFragments.FixAppointment;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activity.startActivity(new Intent(activity, FixAppointment.class)
                        .putExtra("NAME", doc.getFirstName() + " " + doc.getLastName())
                        .putExtra("SPL", doc.getSpecialization()).putExtra("CITY", doc.getCity())
                        .putExtra("ADDR", doc.getAddress()).putExtra("DOCID", doc.getId()));
            }
        });
    }
